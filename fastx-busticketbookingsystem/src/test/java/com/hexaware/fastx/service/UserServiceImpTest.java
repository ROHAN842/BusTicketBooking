...
class UserServiceImpTest {
    ...
    void testGetFaresAndAmenities() {
        Map<Integer, Set<Amenities>> faresAndAmenities = userService.getFaresAndAmenities(7); // Assuming this is the ID of an existing schedule
    ...
    void testGetBookingHistory() {
        List<Booking> bookings = userService.getBookingHistory(52); // Assuming this is the ID of an existing user
