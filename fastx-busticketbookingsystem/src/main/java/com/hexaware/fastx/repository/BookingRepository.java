...
public interface BookingRepository extends JpaRepository<Booking, Integer> {
	...
	int updateRefundStatus(String refundStatus, int bookingID);
	
	// Additional method to update refund status with enum parameter
		default int updateRefundStatus(RefundStatus refundStatus, int bookingID) {
			return updateRefundStatus(refundStatus.toString(), bookingID);
		}
}
